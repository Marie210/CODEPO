...
void setup() {
  ...
  WDT->WDT_MR = WDT_MR_WDD(0xFFF)
                | WDT_MR_WDRPROC
                | WDT_MR_WDRSTEN
                | WDT_MR_WDV(256 * 10); // Watchdog triggers a reset after 2 seconds if underflow
